...
|excludeLogsResponseCodeRegex|false|`""`| By default if send test results as log events enabled, then all logs are reported to Datadog. To exclude based on response code of sample result, set regex here. i.e. `[123][0-5][0-9]` to send only errors|
